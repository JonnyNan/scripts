...
!(async () => {
  ...
  let getShare = false
  let timeH = $.time('H')
  if(Object.getOwnPropertyNames($.shareCodeArr).length > 0 && ($.shareCodeArr["updateTime"] && $.time('d',new Date($.shareCodeArr["updateTime"] || Date.now()).getTime()) == $.time('d')) && timeH != 21 && timeH != 01){
    $.shareCodeArr = {}
