...
!(async () => {
  ...
  // 助力
  let res = [], res2 = [];
  $.innerShInviteList = await getAuthorShareCode('https://gitee.com/xr2021/share/raw/master/jd_summersh.json');
  res2 = await getAuthorShareCode('https://gitee.com/xr2021/share/raw/master/jd_summersh.json');
  $.ShInviteLists = []
  if (ShHelpAuthorFlag) {
