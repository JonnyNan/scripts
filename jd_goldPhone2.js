...
!(async () => {
    ...
    let res = await getAuthorShareCode('https://xr2021.coding.net/p/import-kasd/d/JDbot/git/raw/master/shareCodes/jinji.json')
    if (res && res.length > 0) {
        $.tuanId = getRandomArrayElements(res, 1)[0];
        console.log(`队码：${$.tuanId}`);
    }
