...
!(async () => {
  ...
  if(helpAuthorFlag){
    try{
      res = await getAuthorShareCode('https://gitee.com/xr2021/share/raw/master/jd_summer.json');
      res2 = await getAuthorShareCode(`https://gitee.com/xr2021/share/raw/master/jd_summer.json`);
    }catch (e) {}
    if(!res){res = [];}
    if(!res2){res2 = [];}
  }
