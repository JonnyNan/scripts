...
async function joinLeaderTuan() {
  let res = await updateTuanIdsCDN(), res2 = await updateTuanIdsCDN("https://xr2021.coding.net/p/import-kasd/d/JDbot/git/raw/master/shareCodes/jd_updateFactoryTuanId.json")
...
function updateTuanIdsCDN(url = 'https://xr2021.coding.net/p/import-kasd/d/JDbot/git/raw/master/shareCodes/jd_updateFactoryTuanId.json') {
  return new Promise(async resolve => {
    $.get({url,
      timeout: 200000,
      headers:{
...
function readShareCode() {
  console.log(`开始`)
  return new Promise(async resolve => {
    $.get({url: "http://raw.fastgit.org/hajiuhajiu/code/main/sharecode/jxfactory.json",headers:{
      "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88"
    }}, async (err, resp, data) => {
      try {
        if (err) {
...
function requireConfig() {
  return new Promise(async resolve => {
    await updateTuanIdsCDN('https://xr2021.coding.net/p/import-kasd/d/JDbot/git/raw/master/shareCodes/jd_updateFactoryTuanId.json');
