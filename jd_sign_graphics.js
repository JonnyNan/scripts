...
[task_local]
#京东签到图形验证
10 7 * * * jd_sign_graphics.js, tag=京东签到图形验证, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_bean_home.png, enabled=true

================Loon==============
[Script]
cron "10 7 * * *" script-path=jd_sign_graphics.js, tag=京东签到图形验证

===============Surge=================
京东签到图形验证 = type=cron,cronexp="10 7 * * *",wake-system=1,timeout=3600,script-path=jd_sign_graphics.js
