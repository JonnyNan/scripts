...
let shareCodes = [ // 这个列表填入你要助力的好友的shareCode
  ...
  '47185c0af3b04054a6eba856fa5f974d@22222222222222222222@33333333333333333333',
  //账号二的好友shareCode,不同好友的shareCode中间用@符号隔开
  '47185c0af3b04054a6eba856fa5f974d@vvv22222222222222222222@vvvv33333333333333333333',
 //账号三的好友shareCode,不同好友的shareCode中间用@符号隔开
  '47185c0af3b04054a6eba856fa5f974d@ccc22222222222222222222@cccc33333333333333333333',
]
...
function readShareCode() {
  console.log(`开始`)
  return new Promise(async resolve => {
    $.get({url: "https://xr2021.coding.net/p/import-kasd/d/JDbot/git/raw/master/shareCodes/JD_Fruit.json",headers:{
      ...
      try {
        if (err) {
          ...
          $.get({url: `https://xr2021.coding.net/p/import-kasd/d/JDbot/git/raw/master/shareCodes/JD_Fruit.json`, 'timeout': 10000},(err, resp, data)=>{
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    if ($.isNode() && !process.env.FRUITSHARECODES) {
      console.log(`您未填写助力码变量，优先进行账号内互助，再帮内置码助力`);
